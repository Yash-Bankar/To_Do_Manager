...
function App() {
  ...
  <div className="container w-[100vw] md:w-[70vw] mx-auto flex flex-col items-center min-h-[70vh] p-4 border border-green-500 rounded-3xl mt-10 bg-[#1a1a1a]">
      ...
      <div className="taskhead text-green-500 flex flex-col justify-center items-center md:flex-row md:justify-between md:items-center w-full md:w-[50vw] mt-10">
        <div className=" text-2xl  font-bold">Your tasks:</div>
 ...
 <div className="todos mt-4">
        {todos.length === 0 ? (
          ...
          .map((item, index) => (
            <div key={index} className="todo text-green-500 border border-green-500 rounded-4xl md:rounded-full p-4 mb-4 flex flex-col md:flex-row justify-between items-start md:items-center w-[80vw] md:w-[60vw]">
